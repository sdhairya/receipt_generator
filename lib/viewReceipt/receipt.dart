...
class _receiptState extends State<receipt> {
                              ...
                              child: Center(
                                child: Column(
                                  children: [
                                    SizedBox(height: 8),
                                    components().text(
                                        widget.element_r.resturant_name,
                                        FontWeight.bold,
                                        Colors.black87,
                                        18),
                                    const SizedBox(
                                    ...
                                    components().text(
                                        widget.element_r.resturant_address,
                                        FontWeight.normal,
                                        Colors.black45,
                                        10),
                                    ...
                                    components().text(
                                        widget.element_r.resturant_mobile,
                                        FontWeight.normal,
                                        Colors.black45,
                                        10),
                                    SizedBox(height: 8),
  ...
  Future<void> printDoc(date, time, bytes) async {
    ...
    // print(Printing.listPrinters().toString());
